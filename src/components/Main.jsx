  ...
  return (
    <div className="container">
      <div className="row align-items-center justify-content-center logo-slogan-container">
        <div className="col-12 col-md-auto logo-container">
          <div className="logo"></div>
        </div>
        <div className="col-12 col-md-auto slogan-container">
      ...
      <div className="mt-4 text-container">
        En esta emocionante travesía, nos enfocaremos en <strong>JAVA</strong>, uno de los lenguajes de programación más influyentes y versátiles. Utilizado en millones de dispositivos, desde aplicaciones móviles hasta sistemas empresariales, JAVA es sinónimo de estabilidad y eficiencia.<br/><p></p><strong>¿Por qué aprender JAVA?</strong> Porque es una habilidad invaluable que abrirá puertas en la industria tecnológica. JAVA te permite construir aplicaciones seguras y escalables, habilidades altamente demandadas en el mercado laboral actual. Además, formarás parte de una comunidad global de desarrolladores apasionados, listos para colaborar y compartir conocimientos. <br/><p></p>En CodeBoost Academy, creemos que cada línea de código es un paso hacia un futuro mejor. Con JAVA, tendrás las herramientas para innovar y crear soluciones que transformen el mundo. ¡Únete a nosotros y empieza a impulsar tu código hoy mismo!!
      </div>
    </div>
  );
}
